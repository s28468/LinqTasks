    ...
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task11()
        {
            var result = 
                from emp in Emps
                join dept in Depts on emp.Deptno equals dept.Deptno
                group emp by dept.Dname.ToUpper() into deptGroup
        ...
        /// <summary>
        /// Write your own extension mez`thod that will allow the following code snippet to compile.
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = from dept in Depts
                let employeeCount = Emps.Count(emp => emp.Deptno == dept.Deptno)
        ...
        public static IEnumerable<object> Task15()
        {
            var result = from emp in Emps
                ...
                group emp by emp.Job into jobGroup
                where jobGroup.Count() > 2
                orderby jobGroup.Count() descending
                select new
                {
                    Praca = jobGroup.Key,
                    LiczbaPracownikow = jobGroup.Count()
